        ...
        <script src = 'http://makeevsky-laravel/course-site/resources/js/scroll.js'></script>  
        <script src = 'http://makeevsky-laravel/course-site/resources/js/foodTable.js'></script>  
        <script src = 'http://makeevsky-laravel/course-site/resources/js/form.js'></script>  
    </body>
</html>
