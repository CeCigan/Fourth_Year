...
<main class="w-8/12 m-auto flex flex-col justify-center ">
    <div class="p-3 mt-10 mb-10 info m-auto w-3/4 text-sm text leading-5 text-blue-700 bg-blue-300 border-transparent rounded-xl">
      ...
      <p>
        ...
        Хотите добавить блюдо в свой план? Добавьте его 
        в избранное, и он появится в вашем банке еды на странице
        планировщика.
      </p>
    </div>
